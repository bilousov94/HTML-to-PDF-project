...
var homePage = {
    indexTemplate: _.template(
            ...
            '<div id="myCarousel" class="carousel bs-slider slide  control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="5000">' +
    ...
    homeEvent: function(){
        ...
        $("#news_page").on("click", function(e){
            e.preventDefault();
            $("#main_content").html("<div id = 'news_div' class = 'container'></div>");
            showNews.bindEvents();
        });
